...
class MyGame(arcade.Window):
        ...
        while total_cercles < 20:
            ...
            if len(self.liste_cercles) == 0:
                ...
                for autre_cercle in self.liste_cercles:
                    ...
                    # Distance actuelle
                    dist = self.calculer_distance(center_x, autre_cercle.x, center_y, autre_cercle.y)
    ...
    # calcule la distance cartesienne en utilisant theoreme de Pitagore
    def calculer_distance(self, x1, x2, y1, y2):
        dist_x = x1 - x2
        dist_y = y1 - y2
